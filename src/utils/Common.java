...
public  class Common {
	 ...
	 */
	public String EncodeCreatePassword(String pw, String salt) throws NoSuchAlgorithmException, UnsupportedEncodingException {
	...
	//kiểm tra mã hoa
	/**
	 * So sáng pass do người dùng nhập vào sau khi được mã hóa với pass lấy ra được trong DB
	...
	public boolean checkLogin(HttpSession ss) {
		boolean check=true;
		if("".equals(ss.getAttribute("loginName"))) check =false;
		return check;
	}
	/**
	 * Tao chuoi paging
